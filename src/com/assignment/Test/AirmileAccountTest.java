...
public class AirmileAccountTest {
	static Account account;

	@BeforeClass
	public static void setUp() {
		account = new AirmilesSavingAccount("Test Account", 90);
	}

	// Test For Account Type
	@Test
	public void test1() {
		String expectedClass = "class com.assignment.Model.AirmilesSavingAccount";
